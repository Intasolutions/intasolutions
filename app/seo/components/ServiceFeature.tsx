...
import { FaKey, FaTags, FaTachometerAlt, FaLink, FaChartLine, FaEdit } from "react-icons/fa";

const features = [
  {
    icon: <FaKey size={50} />, 
    title: "Keyword Research & Strategy", 
    description: "Uncover the best keywords to target your audience."
  },
  {
    icon: <FaTags size={50} />, 
    title: "On-Page SEO Optimization", 
    description: "Fine-tune content and tags for maximum visibility."
  },
  {
    icon: <FaTachometerAlt size={50} />, 
    title: "High-Speed Performance", 
    description: "Optimize load times for better rankings and user experience."
  },
  {
    icon: <FaLink size={50} />, 
    title: "Link Building Strategies", 
    description: "Boost authority with quality backlinks that matter."
  },
  {
    icon: <FaChartLine size={50} />, 
    title: "SEO Analytics & Reporting", 
    description: "Track your progress with clear, actionable insights."
  },
  {
    icon: <FaEdit size={50} />, 
    title: "Content Optimization", 
    description: "Create SEO-driven content that resonates and ranks."
  }
];
    ...
    <section className="py-20  text-white text-center relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <motion.p
          ...
          viewport={{ once: true }}
        >
          Our core services ensure your website stands out in the digital world.
        </motion.p>
