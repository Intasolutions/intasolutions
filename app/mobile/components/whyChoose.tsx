...
const features = [
  {
    ...
    description: "We blend creativity with technology to create next-gen mobile solutions."
  },
  {
    icon: <FaCode size={50} />,
    title: "Expert Developers",
    description: "A team of experienced developers skilled in the latest mobile technologies."
  },
  ...
  
  {
    ...
    description: "Faster delivery with an iterative approach for continuous improvements."
  },
];
